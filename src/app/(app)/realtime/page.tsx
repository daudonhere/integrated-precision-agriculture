...
function ThermometerIcon({ status }: { status: 'normal' | 'warning' | 'critical' }) {
  if (status === 'critical') {
    return (
  ...
  if (status === 'warning') {
    return (
      <svg className="h-5 w-5 text-cyan-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 3v18m0-18l-2.5 2.5m2.5-2.5l2.5 2.5M12 21l-2.5-2.5m2.5 2.5l2.5-2.5M3 12h18M3 12l2.5-2.5M3 12l2.5 2.5M21 12l-2.5-2.5M21 12l-2.5 2.5" />
      </svg>
    );
  }
  return (
...
export default function RealtimePage() {
  const { data, isConnected, isConnecting, error, lastReceived } = useMqtt();
        ...
        <div className="text-center">
          ...
          <div className="mt-4 space-y-2 text-xs text-gray-500">
            ...
            <ul className="text-left inline-block">
              ...
              <li>- Wokwi simulation is running</li>
              <li>- MQTT topic: daud/smartfarm/data</li>
            </ul>
          </div>
          <button
      ...
      <div className="flex h-screen flex-col items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-lg font-semibold text-gray-900">
            {isConnecting ? 'Connecting...' : 'Waiting for Data'}
          </h2>
          <p className="mt-1 text-sm text-gray-500">
            {isConnecting ? 'Connecting to broker' : 'Turn on your device to send sensor data'}
          </p>
          {isConnecting && (
